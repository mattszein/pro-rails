...
| Context | Skill |
| ------- | ----- |
| Planning features, scoping ideas, product tradeoffs | `.claude/skills/product-manager/SKILL.md` |
| Architecture decisions, pattern selection, file structure | `.claude/skills/architect/SKILL.md` |
