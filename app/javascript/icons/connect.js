...
export function start(svg) {
  ...
  animate(q(svg, "pin-1"), { d: "M10.43 10.57l0.10 -0.10" }, SPRING)
  animate(q(svg, "pin-2"), { d: "M13.43 13.57l0.10 -0.10" }, SPRING)
}
...
export function stop(svg) {
  ...
  animate(q(svg, "pin-1"), { d: "M7.5 13.5l2.5 -2.5" }, SPRING)
  animate(q(svg, "pin-2"), { d: "M10.5 16.5l2.5 -2.5" }, SPRING)
}
