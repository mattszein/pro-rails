class Core::Form::ButtonComponent < ApplicationViewComponent
  ...
  THEME_MAPPINGS = {
    primary: {
      ...
      hover_border: "hover:border-primary-400 dark:hover:border-primary-300",
    ...
    secondary: {
      ...
      hover_border: "hover:border-secondary-400 dark:hover:border-secondary-300",
    ...
    create: {
      ...
      hover_border: "hover:border-emerald-400 dark:hover:border-emerald-300",
    ...
    edit: {
      ...
      hover_border: "hover:border-blue-400 dark:hover:border-blue-300",
    ...
    delete: {
      ...
      hover_border: "hover:border-red-400 dark:hover:border-red-300",
    ...
    show: {
      ...
      hover_border: "hover:border-indigo-400 dark:hover:border-indigo-300",
  ...
  def html_class
    ...
    class_names(
      ...
      "dark:hover:bg-default dark:focus:bg-default", 
