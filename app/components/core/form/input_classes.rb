module Core::Form::InputClasses
  ...
  def html_class
    class_names("block p-3 w-full text-sm text-gray-600 bg-default rounded border border-gray-200 appearance-none dark:text-white dark:border-gray-600 focus:outline-none focus:ring-2 transition-all duration-200 focus:border-transparent placeholder:text-gray-500 dark:placeholder:text-gray-400", THEMES[theme])
  end
end
