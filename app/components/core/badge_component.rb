class Core::BadgeComponent < ViewComponent::Base
  ...
  THEMES = {
    ...
    secondary: "bg-gradient-to-r from-gray-100 to-slate-100 text-gray-800 border border-gray-200 dark:from-gray-800 dark:to-slate-800 dark:text-gray-200 dark:border-gray-700",
